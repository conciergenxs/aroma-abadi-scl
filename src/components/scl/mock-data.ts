...
export const contacts: Contact[] = [
  // ── Customer Contacts ──────────────────────────────────────────────
  { id: "c1",  name: "Putri Anggraini", phone: "+62 812 3456 7890", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-vip", "lb-beauty-club"], listIds: ["ls-vip", "ls-launch"], lastInteraction: "2m ago",    status: "Active",   avatar: avatars[0],  ownerId: "arma", pointBalance: 4820 },
  { id: "c2",  name: "Bagus Pratama",   phone: "+62 813 2244 5566", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-reseller"],              listIds: ["ls-launch"],            lastInteraction: "11m ago",   status: "Active",   avatar: avatars[1],  ownerId: "arma", pointBalance: 1250 },
  { id: "c3",  name: "Siti Rahmawati",  phone: "+62 821 9988 7766", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-vip"],                   listIds: ["ls-vip", "ls-jakarta"], lastInteraction: "32m ago",   status: "Active",   avatar: avatars[2],  ownerId: "arma", pointBalance: 3670 },
  { id: "c5",  name: "Rizky Maulana",   phone: "+62 822 3344 7788", channel: "whatsapp", gender: "Pria",   labelIds: [],                           listIds: ["ls-community"],         lastInteraction: "2h ago",    status: "Active",   avatar: avatars[4],  ownerId: "arma", pointBalance: 580  },
  { id: "c6",  name: "Indah Permata",   phone: "+62 815 7788 9900", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-vip"],                   listIds: ["ls-vip", "ls-community"],lastInteraction: "3h ago",  status: "Active",   avatar: avatars[5],  ownerId: "arma", pointBalance: 7200 },
  { id: "c7",  name: "Andika Saputra",  phone: "+62 818 4422 1133", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-reseller"],              listIds: ["ls-jakarta"],           lastInteraction: "5h ago",    status: "Active",   avatar: avatars[6],  ownerId: "arma", pointBalance: 990  },
  { id: "c9",  name: "Citra Halim",     phone: "+62 856 1122 3344", channel: "whatsapp", gender: "Wanita", labelIds: [],                           listIds: ["ls-launch","ls-community"],lastInteraction:"Yesterday",status: "Active",  avatar: avatars[8],  ownerId: "arma", pointBalance: 2100 },
  { id: "c11", name: "Bayu Hartanto",   phone: "+62 858 5544 3322", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-vip","lb-reseller"],     listIds: ["ls-vip","ls-jakarta"],  lastInteraction: "3d ago",    status: "Active",   avatar: avatars[10], ownerId: "arma", pointBalance: 5430 },
  { id: "c12", name: "Nadya Salsabila", phone: "+62 877 2211 4455", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-beauty-club"],           listIds: ["ls-bandung","ls-launch"],lastInteraction: "4d ago",  status: "Active",   avatar: avatars[11], ownerId: "arma", pointBalance: 1880 },
  { id: "c13", name: "Ayu Fitriani",    phone: "+62 812 8877 6655", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-vip"],                   listIds: ["ls-vip","ls-jakarta"],  lastInteraction: "1h ago",    status: "Active",   avatar: avatars[12], ownerId: "arma", pointBalance: 3200 },
  { id: "c14", name: "Yusuf Priyanto",  phone: "+62 821 3322 9988", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-reseller"],              listIds: ["ls-launch"],            lastInteraction: "3h ago",    status: "Active",   avatar: avatars[13], ownerId: "arma", pointBalance: 760  },
  { id: "c15", name: "Tiara Hapsari",   phone: "+62 857 4411 0022", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-beauty-club"],           listIds: ["ls-community","ls-launch"],lastInteraction: "5h ago",status: "Active",   avatar: avatars[14], ownerId: "arma", pointBalance: 2340 },
  { id: "c16", name: "Lina Wulandari",  phone: "+62 813 6655 4433", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-vip","lb-beauty-club"],  listIds: ["ls-vip","ls-community"],lastInteraction: "Yesterday", status: "Active",   avatar: avatars[15], ownerId: "arma", pointBalance: 6100 },
  { id: "c17", name: "Galih Santoso",   phone: "+62 878 9900 1122", channel: "whatsapp", gender: "Pria",   labelIds: [],                           listIds: ["ls-jakarta"],           lastInteraction: "Yesterday", status: "Active",   avatar: avatars[16], ownerId: "arma", pointBalance: 420  },
  { id: "c18", name: "Nita Kurniasari", phone: "+62 822 7788 5566", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-beauty-club"],           listIds: ["ls-bandung","ls-community"],lastInteraction:"2d ago", status: "Active",  avatar: avatars[17], ownerId: "arma", pointBalance: 1560 },
  { id: "c19", name: "Fajar Ramadhan",  phone: "+62 819 5544 3311", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-reseller"],              listIds: ["ls-launch","ls-jakarta"],lastInteraction: "2d ago",   status: "Active",   avatar: avatars[18], ownerId: "arma", pointBalance: 870  },
  { id: "c20", name: "Zahra Aulia",     phone: "+62 856 0011 2233", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-vip"],                   listIds: ["ls-vip"],               lastInteraction: "3d ago",    status: "Active",   avatar: avatars[19], ownerId: "arma", pointBalance: 4100 },
  { id: "c21", name: "Mira Rahmawati",  phone: "+62 815 4455 8899", channel: "whatsapp", gender: "Wanita", labelIds: [],                           listIds: ["ls-community"],         lastInteraction: "3d ago",    status: "Active",   avatar: avatars[20], ownerId: "arma", pointBalance: 290  },
  { id: "c22", name: "Dian Puspita",    phone: "+62 877 6677 3344", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-beauty-club"],           listIds: ["ls-bandung"],           lastInteraction: "4d ago",    status: "Active",   avatar: avatars[21], ownerId: "arma", pointBalance: 1730 },

  // ── BA Contacts ────────────────────────────────────────────────────
  { id: "c4",  name: "Dewi Lestari",    phone: "+62 811 5566 1122", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "1h ago",    status: "Active", avatar: avatars[3],  ownerId: "arma", pointBalance: 0 },
  { id: "c8",  name: "Maya Kusuma",     phone: "+62 819 6655 2244", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "Yesterday", status: "Active", avatar: avatars[7],  ownerId: "arma", pointBalance: 0 },
  { id: "c10", name: "Reza Wijaya",     phone: "+62 857 8899 0011", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-ba"], listIds: [], lastInteraction: "2d ago",    status: "Active", avatar: avatars[9],  ownerId: "arma", pointBalance: 0 },
  { id: "c23", name: "Hesti Andriani",  phone: "+62 811 2233 4455", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "30m ago",   status: "Active", avatar: avatars[22], ownerId: "arma", pointBalance: 0 },
  { id: "c24", name: "Indra Wahyudi",   phone: "+62 821 8877 6655", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-ba"], listIds: [], lastInteraction: "1h ago",    status: "Active", avatar: avatars[23], ownerId: "arma", pointBalance: 0 },
  { id: "c25", name: "Wulan Sari",      phone: "+62 857 3344 5566", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "2h ago",    status: "Active", avatar: avatars[24], ownerId: "arma", pointBalance: 0 },
  { id: "c26", name: "Kevin Nugroho",   phone: "+62 812 9900 8877", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-ba"], listIds: [], lastInteraction: "4h ago",    status: "Active", avatar: avatars[25], ownerId: "arma", pointBalance: 0 },
  { id: "c27", name: "Sinta Bella",     phone: "+62 819 1122 7788", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "Yesterday", status: "Active", avatar: avatars[26], ownerId: "arma", pointBalance: 0 },
  { id: "c28", name: "Rizal Pratama",   phone: "+62 878 5566 4433", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-ba"], listIds: [], lastInteraction: "Yesterday", status: "Active", avatar: avatars[27], ownerId: "arma", pointBalance: 0 },
  { id: "c29", name: "Olivia Lim",      phone: "+62 813 3344 9900", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "2d ago",    status: "Active", avatar: avatars[28], ownerId: "arma", pointBalance: 0 },
  { id: "c30", name: "Eka Marlinda",    phone: "+62 856 7788 1122", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "2d ago",    status: "Active", avatar: avatars[29], ownerId: "arma", pointBalance: 0 },
  { id: "c31", name: "Mia Hartanti",    phone: "+62 812 1100 2233", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "45m ago",   status: "Active", avatar: avatars[30], ownerId: "arma", pointBalance: 0 },
  { id: "c32", name: "Fauzan Akbar",    phone: "+62 821 4455 6677", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-ba"], listIds: [], lastInteraction: "2h ago",    status: "Active", avatar: avatars[31], ownerId: "arma", pointBalance: 0 },
  { id: "c33", name: "Nadia Pramesti",  phone: "+62 857 9988 1100", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "3h ago",    status: "Active", avatar: avatars[32], ownerId: "arma", pointBalance: 0 },
  { id: "c34", name: "Bintang Ramadan", phone: "+62 813 5544 7788", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-ba"], listIds: [], lastInteraction: "Yesterday", status: "Active", avatar: avatars[33], ownerId: "arma", pointBalance: 0 },
  { id: "c35", name: "Clara Santika",   phone: "+62 878 2211 3344", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "Yesterday", status: "Active", avatar: avatars[34], ownerId: "arma", pointBalance: 0 },
  { id: "c36", name: "Ariel Wijaya",    phone: "+62 812 6677 8899", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-ba"], listIds: [], lastInteraction: "2d ago",    status: "Active", avatar: avatars[35], ownerId: "arma", pointBalance: 0 },
  { id: "c37", name: "Fina Rahayu",     phone: "+62 819 3322 5566", channel: "whatsapp", gender: "Wanita", labelIds: ["lb-ba"], listIds: [], lastInteraction: "2d ago",    status: "Active", avatar: avatars[36], ownerId: "arma", pointBalance: 0 },
  { id: "c38", name: "Dodi Kurnia",     phone: "+62 856 4433 9900", channel: "whatsapp", gender: "Pria",   labelIds: ["lb-ba"], listIds: [], lastInteraction: "3d ago",    status: "Active", avatar: avatars[37], ownerId: "arma", pointBalance: 0 },
];
