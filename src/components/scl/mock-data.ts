...
export const contacts: Contact[] = [
  // ── Customer Contacts ──────────────────────────────────────────────
  { id: "c1",  name: "Putri Anggraini", phone: "+62 812 3456 7890", channel: "whatsapp", gender: "Female", labelIds: ["lb-vip", "lb-beauty-club"], listIds: ["ls-vip", "ls-launch"],      brandIds: ["brand-sisley", "brand-dg"],      lastInteraction: "2m ago",    status: "Active",   avatar: avatars[0],  ownerId: "arma", pointBalance: 4820 },
  { id: "c2",  name: "Bagus Pratama",   phone: "+62 813 2244 5566", channel: "whatsapp", gender: "Male",   labelIds: ["lb-reseller"],              listIds: ["ls-launch"],                 brandIds: ["brand-rimmel"],                  lastInteraction: "11m ago",   status: "Active",   avatar: avatars[1],  ownerId: "arma", pointBalance: 1250 },
  { id: "c3",  name: "Siti Rahmawati",  phone: "+62 821 9988 7766", channel: "whatsapp", gender: "Female", labelIds: ["lb-vip"],                   listIds: ["ls-vip", "ls-jakarta"],      brandIds: ["brand-sisley"],                  lastInteraction: "32m ago",   status: "Active",   avatar: avatars[2],  ownerId: "arma", pointBalance: 3670 },
  { id: "c5",  name: "Rizky Maulana",   phone: "+62 822 3344 7788", channel: "whatsapp", gender: "Male",   labelIds: [],                           listIds: ["ls-community"],              brandIds: ["brand-bm"],                      lastInteraction: "2h ago",    status: "Active",   avatar: avatars[4],  ownerId: "arma", pointBalance: 580  },
  { id: "c6",  name: "Indah Permata",   phone: "+62 815 7788 9900", channel: "whatsapp", gender: "Female", labelIds: ["lb-vip"],                   listIds: ["ls-vip", "ls-community"],    brandIds: ["brand-dg", "brand-sisley"],      lastInteraction: "3h ago",    status: "Active",   avatar: avatars[5],  ownerId: "arma", pointBalance: 7200 },
  { id: "c7",  name: "Andika Saputra",  phone: "+62 818 4422 1133", channel: "whatsapp", gender: "Male",   labelIds: ["lb-reseller"],              listIds: ["ls-jakarta"],                brandIds: ["brand-rimmel"],                  lastInteraction: "5h ago",    status: "Active",   avatar: avatars[6],  ownerId: "arma", pointBalance: 990  },
  { id: "c9",  name: "Citra Halim",     phone: "+62 856 1122 3344", channel: "whatsapp", gender: "Female", labelIds: [],                           listIds: ["ls-launch","ls-community"],  brandIds: ["brand-laura"],                   lastInteraction: "Yesterday", status: "Active",   avatar: avatars[8],  ownerId: "arma", pointBalance: 2100 },
  { id: "c11", name: "Bayu Hartanto",   phone: "+62 858 5544 3322", channel: "whatsapp", gender: "Male",   labelIds: ["lb-vip","lb-reseller"],     listIds: ["ls-vip","ls-jakarta"],       brandIds: ["brand-sisley", "brand-rimmel"],  lastInteraction: "3d ago",    status: "Active",   avatar: avatars[10], ownerId: "arma", pointBalance: 5430 },
  { id: "c12", name: "Nadya Salsabila", phone: "+62 877 2211 4455", channel: "whatsapp", gender: "Female", labelIds: ["lb-beauty-club"],           listIds: ["ls-bandung","ls-launch"],    brandIds: ["brand-laura"],                   lastInteraction: "4d ago",    status: "Active",   avatar: avatars[11], ownerId: "arma", pointBalance: 1880 },
  { id: "c13", name: "Ayu Fitriani",    phone: "+62 812 8877 6655", channel: "whatsapp", gender: "Female", labelIds: ["lb-vip"],                   listIds: ["ls-vip","ls-jakarta"],       brandIds: ["brand-dg"],                      lastInteraction: "1h ago",    status: "Active",   avatar: avatars[12], ownerId: "arma", pointBalance: 3200 },
  { id: "c14", name: "Yusuf Priyanto",  phone: "+62 821 3322 9988", channel: "whatsapp", gender: "Male",   labelIds: ["lb-reseller"],              listIds: ["ls-launch"],                 brandIds: ["brand-rimmel"],                  lastInteraction: "3h ago",    status: "Active",   avatar: avatars[13], ownerId: "arma", pointBalance: 760  },
  { id: "c15", name: "Tiara Hapsari",   phone: "+62 857 4411 0022", channel: "whatsapp", gender: "Female", labelIds: ["lb-beauty-club"],           listIds: ["ls-community","ls-launch"],  brandIds: ["brand-sisley"],                  lastInteraction: "5h ago",    status: "Active",   avatar: avatars[14], ownerId: "arma", pointBalance: 2340 },
  { id: "c16", name: "Lina Wulandari",  phone: "+62 813 6655 4433", channel: "whatsapp", gender: "Female", labelIds: ["lb-vip","lb-beauty-club"],  listIds: ["ls-vip","ls-community"],     brandIds: ["brand-dg", "brand-laura"],       lastInteraction: "Yesterday", status: "Active",   avatar: avatars[15], ownerId: "arma", pointBalance: 6100 },
  { id: "c17", name: "Galih Santoso",   phone: "+62 878 9900 1122", channel: "whatsapp", gender: "Male",   labelIds: [],                           listIds: ["ls-jakarta"],                brandIds: ["brand-bm"],                      lastInteraction: "Yesterday", status: "Active",   avatar: avatars[16], ownerId: "arma", pointBalance: 420  },
  { id: "c18", name: "Nita Kurniasari", phone: "+62 822 7788 5566", channel: "whatsapp", gender: "Female", labelIds: ["lb-beauty-club"],           listIds: ["ls-bandung","ls-community"], brandIds: ["brand-sisley"],                  lastInteraction: "2d ago",    status: "Active",   avatar: avatars[17], ownerId: "arma", pointBalance: 1560 },
  { id: "c19", name: "Fajar Ramadhan",  phone: "+62 819 5544 3311", channel: "whatsapp", gender: "Male",   labelIds: ["lb-reseller"],              listIds: ["ls-launch","ls-jakarta"],    brandIds: ["brand-rimmel"],                  lastInteraction: "2d ago",    status: "Active",   avatar: avatars[18], ownerId: "arma", pointBalance: 870  },
  { id: "c20", name: "Zahra Aulia",     phone: "+62 856 0011 2233", channel: "whatsapp", gender: "Female", labelIds: ["lb-vip"],                   listIds: ["ls-vip"],                    brandIds: ["brand-dg"],                      lastInteraction: "3d ago",    status: "Active",   avatar: avatars[19], ownerId: "arma", pointBalance: 4100 },
  { id: "c21", name: "Mira Rahmawati",  phone: "+62 815 4455 8899", channel: "whatsapp", gender: "Female", labelIds: [],                           listIds: ["ls-community"],              brandIds: ["brand-laura"],                   lastInteraction: "3d ago",    status: "Active",   avatar: avatars[20], ownerId: "arma", pointBalance: 290  },
  { id: "c22", name: "Dian Puspita",    phone: "+62 877 6677 3344", channel: "whatsapp", gender: "Female", labelIds: ["lb-beauty-club"],           listIds: ["ls-bandung"],                brandIds: ["brand-sisley"],                  lastInteraction: "4d ago",    status: "Active",   avatar: avatars[21], ownerId: "arma", pointBalance: 1730 },

  // ── BA Contacts ────────────────────────────────────────────────────
  { id: "c4",  name: "Dewi Lestari",    phone: "+62 811 5566 1122", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-sisley"],               lastInteraction: "1h ago",    status: "Active", avatar: avatars[3],  ownerId: "arma", pointBalance: 0 },
  { id: "c8",  name: "Maya Kusuma",     phone: "+62 819 6655 2244", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-dg"],                   lastInteraction: "Yesterday", status: "Active", avatar: avatars[7],  ownerId: "arma", pointBalance: 0 },
  { id: "c10", name: "Reza Wijaya",     phone: "+62 857 8899 0011", channel: "whatsapp", gender: "Male",   labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-rimmel"],               lastInteraction: "2d ago",    status: "Active", avatar: avatars[9],  ownerId: "arma", pointBalance: 0 },
  { id: "c23", name: "Hesti Andriani",  phone: "+62 811 2233 4455", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-laura"],                lastInteraction: "30m ago",   status: "Active", avatar: avatars[22], ownerId: "arma", pointBalance: 0 },
  { id: "c24", name: "Indra Wahyudi",   phone: "+62 821 8877 6655", channel: "whatsapp", gender: "Male",   labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-bm"],                   lastInteraction: "1h ago",    status: "Active", avatar: avatars[23], ownerId: "arma", pointBalance: 0 },
  { id: "c25", name: "Wulan Sari",      phone: "+62 857 3344 5566", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-dg"],                   lastInteraction: "2h ago",    status: "Active", avatar: avatars[24], ownerId: "arma", pointBalance: 0 },
  { id: "c26", name: "Kevin Nugroho",   phone: "+62 812 9900 8877", channel: "whatsapp", gender: "Male",   labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-sisley"],               lastInteraction: "4h ago",    status: "Active", avatar: avatars[25], ownerId: "arma", pointBalance: 0 },
  { id: "c27", name: "Sinta Bella",     phone: "+62 819 1122 7788", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-rimmel"],               lastInteraction: "Yesterday", status: "Active", avatar: avatars[26], ownerId: "arma", pointBalance: 0 },
  { id: "c28", name: "Rizal Pratama",   phone: "+62 878 5566 4433", channel: "whatsapp", gender: "Male",   labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-laura"],                lastInteraction: "Yesterday", status: "Active", avatar: avatars[27], ownerId: "arma", pointBalance: 0 },
  { id: "c29", name: "Olivia Lim",      phone: "+62 813 3344 9900", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-bm"],                   lastInteraction: "2d ago",    status: "Active", avatar: avatars[28], ownerId: "arma", pointBalance: 0 },
  { id: "c30", name: "Eka Marlinda",    phone: "+62 856 7788 1122", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-dg", "brand-sisley"],   lastInteraction: "2d ago",    status: "Active", avatar: avatars[29], ownerId: "arma", pointBalance: 0 },
  { id: "c31", name: "Mia Hartanti",    phone: "+62 812 1100 2233", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-sisley"],               lastInteraction: "45m ago",   status: "Active", avatar: avatars[30], ownerId: "arma", pointBalance: 0 },
  { id: "c32", name: "Fauzan Akbar",    phone: "+62 821 4455 6677", channel: "whatsapp", gender: "Male",   labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-rimmel"],               lastInteraction: "2h ago",    status: "Active", avatar: avatars[31], ownerId: "arma", pointBalance: 0 },
  { id: "c33", name: "Nadia Pramesti",  phone: "+62 857 9988 1100", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-laura"],                lastInteraction: "3h ago",    status: "Active", avatar: avatars[32], ownerId: "arma", pointBalance: 0 },
  { id: "c34", name: "Bintang Ramadan", phone: "+62 813 5544 7788", channel: "whatsapp", gender: "Male",   labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-bm"],                   lastInteraction: "Yesterday", status: "Active", avatar: avatars[33], ownerId: "arma", pointBalance: 0 },
  { id: "c35", name: "Clara Santika",   phone: "+62 878 2211 3344", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-dg"],                   lastInteraction: "Yesterday", status: "Active", avatar: avatars[34], ownerId: "arma", pointBalance: 0 },
  { id: "c36", name: "Ariel Wijaya",    phone: "+62 812 6677 8899", channel: "whatsapp", gender: "Male",   labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-sisley"],               lastInteraction: "2d ago",    status: "Active", avatar: avatars[35], ownerId: "arma", pointBalance: 0 },
  { id: "c37", name: "Fina Rahayu",     phone: "+62 819 3322 5566", channel: "whatsapp", gender: "Female", labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-rimmel", "brand-laura"], lastInteraction: "2d ago",   status: "Active", avatar: avatars[36], ownerId: "arma", pointBalance: 0 },
  { id: "c38", name: "Dodi Kurnia",     phone: "+62 856 4433 9900", channel: "whatsapp", gender: "Male",   labelIds: ["lb-ba"], listIds: [], brandIds: ["brand-bm"],                   lastInteraction: "3d ago",    status: "Active", avatar: avatars[37], ownerId: "arma", pointBalance: 0 },
];
...
export const threadsByContact: Record<string, Message[]> = {
  c1: [
    { id: "m1", from: "them", text: "Halo kak! Lipstick Velvet Rouge shade 03 ready stock ga?", time: "10:22" },
    { id: "m2", from: "me", text: "Halo Putri! Shade 03 baru restock pagi ini. Mau aku reserve satu?", time: "10:23", status: "read" },
    { id: "m3", from: "them", text: "Mau dong 🙏 boleh pakai diskon Beauty Club ku?", time: "10:24" },
    { id: "m4", from: "me", text: "Sudah diaplikasikan. Link checkout privat: aroma.id/v/putri-22", time: "10:25", status: "read" },
    { id: "m5", from: "them", text: "Makasih banyak! Aku checkout sekarang ya.", time: "10:26" },
  ],
  c2: [
    { id: "m1", from: "them", text: "Min, untuk reseller Glow Serum minimum order berapa pcs?", time: "09:48" },
    { id: "m2", from: "me", text: "Halo Bagus! Mulai 24 pcs untuk harga reseller. Aku kirim katalognya ya.", time: "09:50", status: "delivered" },
  ],
  c3: [
    { id: "m1", from: "them", text: "Mau pesan hampers Lebaran 120 pax untuk karyawan kami.", time: "Yesterday" },
...
export const templates: Template[] = [
  { id: "tp1", name: "Velvet Rouge Launch", category: "Marketing", channel: "whatsapp", status: "Approved", updated: "2h ago", body: "Hi {{1}}, koleksi Velvet Rouge baru saja launching! VIP Beauty Club dapat akses 24 jam lebih awal — tap untuk belanja.", groupId: "tg-promotions", language: "id_ID" },
  { id: "tp2", name: "Order Shipped", category: "Utility", channel: "whatsapp", status: "Approved", updated: "1d ago", body: "Order kamu {{1}} sudah dikirim. Lacak di sini: {{2}}", groupId: "tg-transactional", language: "id_ID" },
  { id: "tp3", name: "Cart Reminder", category: "Marketing", channel: "whatsapp", status: "Approved", updated: "3d ago", body: "Hi {{1}}, cart kamu masih nunggu. Kami hold {{2}} untuk 24 jam ke depan.", groupId: "tg-promotions", language: "id_ID" },
  { id: "tp4", name: "Reminder Beauty Class", category: "Reminder", channel: "whatsapp", status: "Approved", updated: "1w ago", body: "Reminder: kelas makeup kamu besok jam {{1}} bersama {{2}}.", groupId: "tg-events", language: "id_ID" },
  { id: "tp5", name: "Ticket Follow-up", category: "Service", channel: "whatsapp", status: "Pending", updated: "5h ago", body: "Hi {{1}}, kami follow-up tiket #{{2}}. Sudah teratasi?", groupId: "tg-cs", language: "id_ID" },
  { id: "tp6", name: "Beauty Club Upgrade", category: "Marketing", channel: "whatsapp", status: "Draft", updated: "30m ago", body: "Selamat {{1}}! Kamu naik ke tier Platinum. Berikut benefit baru untukmu.", groupId: "tg-loyalty", language: "id_ID" },
  { id: "tp7", name: "Restock Alert", category: "Utility", channel: "whatsapp", status: "Approved", updated: "2w ago", body: "{{1}} yang kamu wishlist sudah ready stock lagi. Tap untuk order.", groupId: "tg-transactional", language: "id_ID" },
  { id: "tp8", name: "Payment Failed", category: "Service", channel: "whatsapp", status: "Pending", updated: "6h ago", body: "Halo {{1}} — pembayaran order {{2}} gagal. Coba lagi di sini.", groupId: "tg-cs", language: "id_ID" },
  { id: "tp9", name: "Flash Sale", category: "Marketing", channel: "whatsapp", status: "Rejected", updated: "1d ago", body: "🔥 FLASH SALE {{1}}! DISKON 80% SEMUA PRODUK — KLIK SEKARANG!", groupId: "tg-promotions", language: "id_ID", rejectionReason: "Content uses all-caps and excessive promotional language, which violates WhatsApp Business policy." },
];
...
export const broadcasts: Broadcast[] = [
  { id: "b1", name: "Velvet Rouge — VIP Early Access", channel: "whatsapp", audience: "VIP · 12,408", reach: 12408, delivered: 12380, read: 11244, clicks: 4128, sentAt: "Today · 09:00", sentAtDate: "2026-07-30", status: "Sent",
    channelId: "wa-main", listIds: ["ls-vip", "ls-launch"], totalAudience: 12408, sendMode: "now", createdBy: "Putri Anggraini", createdAt: "Today · 08:42",
  ...
  { id: "b2", name: "Glow Serum — Reseller Promo", channel: "whatsapp", audience: "Reseller · 4,910", reach: 4910, delivered: 4880, read: 4112, clicks: 1342, sentAt: "Yesterday", sentAtDate: "2026-07-29", status: "Sent",
    channelId: "wa-bdg", listIds: ["ls-launch"], totalAudience: 4910, sendMode: "now", createdBy: "Bagus Pratama", createdAt: "Yesterday · 17:10",
  ...
  { id: "b3", name: "Promo Ramadhan Glow Set", channel: "whatsapp", audience: "All Contacts · 84,221", reach: 84221, delivered: 0, read: 0, clicks: 0, sentAt: "Fri · 08:00", status: "Scheduled",
    ...
    createdBy: "Putri Anggraini", createdAt: "2 days ago",
  ...
  { id: "b4", name: "Corporate Hampers Lebaran", channel: "whatsapp", audience: "Corporate · 612", reach: 612, delivered: 610, read: 588, clicks: 244, sentAt: "3 days ago", sentAtDate: "2026-07-27", status: "Sent",
    channelId: "wa-jkt", listIds: ["ls-vip"], totalAudience: 612, sendMode: "now", createdBy: "Siti Rahmawati", createdAt: "3 days ago",
  ...
  { id: "b5", name: "Beauty Club Tier Refresh", channel: "whatsapp", audience: "Active Customers · 22,114", reach: 22114, delivered: 0, read: 0, clicks: 0, sentAt: "—", status: "Draft",
    channelId: "wa-main", listIds: ["ls-community"], totalAudience: 22114, sendMode: "now", createdBy: "Indah Permata", createdAt: "30 minutes ago",
    contentMode: "template", templateId: "tp6", body: "Selamat {{name}}! Kamu naik ke tier Beauty Club berikutnya. Berikut benefit baru untukmu.",
    buttons: [{ label: "Lihat benefit", kind: "url" }], replied: 0, failed: 0 },
];
