...
export const Route = createFileRoute("/access-denied")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Beauty Ambassador accounts don't have access to the ARMA dashboard.",
      },
    ],
  }),
    ...
    <div className="min-h-screen w-full bg-background text-foreground flex items-center justify-center px-6 py-10">
      <div className="w-full max-w-[440px] text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
          Beauty Ambassador accounts are for the Aroma Abadi WhatsApp assistant and LMS only. The
          ARMA dashboard is reserved for workspace admins and team members.
        </p>
        <a
          href={LMS_URL}
