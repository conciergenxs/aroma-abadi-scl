            ...
            <div className="flex items-center gap-3">
              ...
              <label className="flex items-center gap-1">
                ...
                <select
                  ...
                  className="h-7 rounded-md border border-gray-200 bg-white pl-2 pr-6 text-xs scl-native-select ml-1"
                >
                  {[5, 10, 20, 50].map((n) => (
...
function GroupPickerModal({
  ...
  return (
    ...
    >
      <div
        onClick={(e) => e.stopPropagation()}
        className="w-full max-w-md rounded-xl border border-border bg-card shadow-2xl flex flex-col overflow-hidden modal-content"
      >
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-border">
